...
- Implementation: `.aicockpit/tools/aidlc-worktree.ts` (`handleInfo` handler)
- Test: `tests/unit/t72-worktree-info.sh`
- Caller: `.aicockpit/skills/aidlc/SKILL.md` (per-Bolt-loop halt-and-ask flow)
...
- Audit-format spec: `.aicockpit/knowledge/aidlc-shared/audit-format.md` `WORKTREE_CREATED` row
